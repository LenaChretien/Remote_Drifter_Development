...
text(time(1)+0.02,7,'Speed [m/s]','color','w','fontsize',13,'fontweight','bold')
...
box on 
set(gca,'xlim',[time(1) time(end)],'ylim',[1.5 8])
text(time(1)+0.02,7,'u velocity [m/s]','color','w','fontsize',13,'fontweight','bold')
datetick('x',15,'keeplimits','keepticks')
text(time(1)+0.02,9,'18 May 2017','fontsize',12)
set(gca,'fontsize',12)
ylabel('Depth [m]')
...
box on 
set(gca,'xlim',[time(1) time(end)],'ylim',[1.5 8])
text(time(1)+0.02,7,'v velocity [m/s]','color','w','fontsize',13,'fontweight','bold')
datetick('x',15,'keeplimits','keepticks')
text(time(1)+0.02,9,'18 May 2017','fontsize',12)
set(gca,'fontsize',12)
ylabel('Depth [m]')
...
print -f -dpng /Users/Lena/Documents/BottomDrifter/Matlab/Plots/Velocity_5_18
